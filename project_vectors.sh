...
python3 alignVectors.py -w1 $1 -w2 $2 -a $3 -o $4
...
python3 paste.py -1 $4_words2.txt -2 $4_orig2_projected.txt -o $4_inter_orig2_projected.txt -d" "
rm -f $4_words2.txt
...
python3 paste.py -1 $4_words1.txt -2 $4_orig1_projected.txt -o $4_inter_orig1_projected.txt -d" "
rm -f $4_words1.txt
